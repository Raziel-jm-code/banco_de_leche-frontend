...
export const SignUpForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      // Llamar al mutation para crear el usuario
      ...
      console.error("Error details:", error.graphQLErrors, error.networkError, error.message);
    }
  };
    ...
    <section className="min-h-screen flex items-stretch text-white">
      <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{ backgroundImage: 'url(https://acunarperinatal.com/wp-content/uploads/2023/03/shutterstock_1255518868-1-1024x683.jpg)' }}>
        ...
        <div className="w-full px-24 z-10">
          <p className="text-3xl my-4 text-black">Banco de Leche Materna</p>
        </div>
